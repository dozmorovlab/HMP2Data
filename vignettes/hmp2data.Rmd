...
The demographic data contained in `HMP2Data` can be summarized using the `table_two` function. First, we need to make a list of the phyloseq and summarized experiment object which can then be entered into the table generating function.
